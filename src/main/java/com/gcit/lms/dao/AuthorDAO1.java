...
public class AuthorDAO1  {
	...
	public int saveAuthorWithId(final String authorName)  {
	...
	public int updateAuthor(Integer authorId, String authorName) {
		int i = jdbcTemplate.update("update tbl_author set authorName = ? where authorid = ?" , 
				new Object[] { authorName, authorId });
		return i;
	}
}
